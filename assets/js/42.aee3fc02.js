...
var ClassMember = class {
  static {
    (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(this, "ClassMember");
  }
  constructor(input, memberType) {
    this.memberType = memberType;
    this.visibility = "";
    this.classifier = "";
    const sanitizedInput = (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .sanitizeText */ .jZ)(input, (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getConfig2 */ .D7)());
    this.parseMember(sanitizedInput);
  }
  getDisplayDetails() {
    let displayText = this.visibility + (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .parseGenericTypes */ .QO)(this.id);
    if (this.memberType === "method") {
      displayText += `(${(0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .parseGenericTypes */ .QO)(this.parameters.trim())})`;
      if (this.returnType) {
        displayText += " : " + (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .parseGenericTypes */ .QO)(this.returnType);
      }
    }
...
var functions = [];
var sanitizeText2 = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)((txt) => _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .common_default */ .Y2.sanitizeText(txt, (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getConfig2 */ .D7)()), "sanitizeText");
var splitClassNameAndType = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(_id) {
  const id = _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .common_default */ .Y2.sanitizeText(_id, (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getConfig2 */ .D7)());
  let genericType = "";
  let className = id;
  if (id.indexOf("~") > 0) {
...
var setClassLabel = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(_id, label) {
  const id = _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .common_default */ .Y2.sanitizeText(_id, (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getConfig2 */ .D7)());
  if (label) {
...
var addClass = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(_id) {
  const id = _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .common_default */ .Y2.sanitizeText(_id, (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getConfig2 */ .D7)());
  const { className, type } = splitClassNameAndType(id);
  if (classes.has(className)) {
    return;
  }
  const name = _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .common_default */ .Y2.sanitizeText(className, (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getConfig2 */ .D7)());
  classes.set(name, {
    id: name,
    type,
    label: name,
...
var lookUpDomId = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(_id) {
  const id = _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .common_default */ .Y2.sanitizeText(_id, (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getConfig2 */ .D7)());
  if (classes.has(id)) {
...
var getClass = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(id) {
  return classes.get(id);
}, "getClass");
var getClasses = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function() {
  return classes;
}, "getClasses");
var getRelations = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function() {
  return relations;
}, "getRelations");
var getNotes = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function() {
  return notes;
}, "getNotes");
var addRelation = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(relation) {
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .log */ .Rm.debug("Adding relation: " + JSON.stringify(relation));
  addClass(relation.id1);
  addClass(relation.id2);
  relation.id1 = splitClassNameAndType(relation.id1).className;
  relation.id2 = splitClassNameAndType(relation.id2).className;
  relation.relationTitle1 = _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .common_default */ .Y2.sanitizeText(relation.relationTitle1.trim(), (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getConfig2 */ .D7)());
  relation.relationTitle2 = _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .common_default */ .Y2.sanitizeText(relation.relationTitle2.trim(), (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getConfig2 */ .D7)());
  relations.push(relation);
}, "addRelation");
var addAnnotation = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(className, annotation) {
  const validatedClassName = splitClassNameAndType(className).className;
  classes.get(validatedClassName).annotations.push(annotation);
}, "addAnnotation");
var addMember = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(className, member) {
  addClass(className);
  const validatedClassName = splitClassNameAndType(className).className;
...
var addMembers = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(className, members) {
  if (Array.isArray(members)) {
    members.reverse();
    members.forEach((member) => addMember(className, member));
  }
}, "addMembers");
var addNote = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(text, className) {
  const note = {
...
var cleanupLabel = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(label) {
  if (label.startsWith(":")) {
    label = label.substring(1);
  }
  return sanitizeText2(label.trim());
}, "cleanupLabel");
var setCssClass = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(ids, className) {
...
var setTooltip = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(ids, tooltip) {
...
var getTooltip = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(id, namespace) {
  if (namespace && namespaces.has(namespace)) {
    return namespaces.get(namespace).classes.get(id).tooltip;
  }
  return classes.get(id).tooltip;
}, "getTooltip");
var setLink = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(ids, linkStr, target) {
  ...
  ids.split(",").forEach(function(_id) {
    ...
    if (theClass) {
      theClass.link = _chunk_VKXSJROQ_mjs__WEBPACK_IMPORTED_MODULE_0__/* .utils_default */ ._K.formatUrl(linkStr, config);
...
var setClickEvent = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(ids, functionName, functionArgs) {
  ids.split(",").forEach(function(id) {
...
var setClickFunc = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(_domId, functionName, functionArgs) {
  const domId = _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .common_default */ .Y2.sanitizeText(_domId, (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getConfig2 */ .D7)());
  const config = (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getConfig2 */ .D7)();
    ...
    functions.push(function() {
      ...
      if (elem !== null) {
        elem.addEventListener(
          "click",
          function() {
            _chunk_VKXSJROQ_mjs__WEBPACK_IMPORTED_MODULE_0__/* .utils_default */ ._K.runFunc(functionName, ...argList);
          },
          false
        );
      }
...
var bindFunctions = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(element) {
...
var setupToolTips = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(element) {
...
functions.push(setupToolTips);
var direction = "TB";
var getDirection = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(() => direction, "getDirection");
var setDirection = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)((dir) => {
  direction = dir;
}, "setDirection");
var addNamespace = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(id) {
...
var getNamespace = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(name) {
  return namespaces.get(name);
}, "getNamespace");
var getNamespaces = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function() {
  return namespaces;
}, "getNamespaces");
var addClassesToNamespace = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(id, classNames) {
  if (!namespaces.has(id)) {
    return;
  }
...
var setCssStyle = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(function(id, styles) {
...
var classDb_default = {
  ...
  getConfig: /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)(() => (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getConfig2 */ .D7)().class, "getConfig"),
  addClass,
  bindFunctions,
  clear: clear2,
  getClass,
...
var getStyles = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .K2)((options) => `g.classGroup text {
...
/* harmony export */ });
/* harmony import */ var _chunk_Z2VRG6XP_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(46578);
/* harmony import */ var _chunk_TINLTEC2_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(48496);
/* harmony import */ var _chunk_OERGPBFJ_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(67895);
/* harmony import */ var _chunk_VKXSJROQ_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(57323);
/* harmony import */ var _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(64994);
...
var insertMarkers = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((elem, markerArray, type, id) => {
  markerArray.forEach((markerName) => {
    markers[markerName](elem, type, id);
  });
}, "insertMarkers");
var extension = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((elem, type, id) => {
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.trace("Making markers for ", id);
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-extensionStart").attr("class", "marker extension " + type).attr("refX", 18).attr("refY", 7).attr("markerWidth", 190).attr("markerHeight", 240).attr("orient", "auto").append("path").attr("d", "M 1,7 L18,13 V 1 Z");
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-extensionEnd").attr("class", "marker extension " + type).attr("refX", 1).attr("refY", 7).attr("markerWidth", 20).attr("markerHeight", 28).attr("orient", "auto").append("path").attr("d", "M 1,1 V 13 L18,7 Z");
}, "extension");
var composition = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((elem, type, id) => {
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-compositionStart").attr("class", "marker composition " + type).attr("refX", 18).attr("refY", 7).attr("markerWidth", 190).attr("markerHeight", 240).attr("orient", "auto").append("path").attr("d", "M 18,7 L9,13 L1,7 L9,1 Z");
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-compositionEnd").attr("class", "marker composition " + type).attr("refX", 1).attr("refY", 7).attr("markerWidth", 20).attr("markerHeight", 28).attr("orient", "auto").append("path").attr("d", "M 18,7 L9,13 L1,7 L9,1 Z");
}, "composition");
var aggregation = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((elem, type, id) => {
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-aggregationStart").attr("class", "marker aggregation " + type).attr("refX", 18).attr("refY", 7).attr("markerWidth", 190).attr("markerHeight", 240).attr("orient", "auto").append("path").attr("d", "M 18,7 L9,13 L1,7 L9,1 Z");
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-aggregationEnd").attr("class", "marker aggregation " + type).attr("refX", 1).attr("refY", 7).attr("markerWidth", 20).attr("markerHeight", 28).attr("orient", "auto").append("path").attr("d", "M 18,7 L9,13 L1,7 L9,1 Z");
}, "aggregation");
var dependency = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((elem, type, id) => {
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-dependencyStart").attr("class", "marker dependency " + type).attr("refX", 6).attr("refY", 7).attr("markerWidth", 190).attr("markerHeight", 240).attr("orient", "auto").append("path").attr("d", "M 5,7 L9,13 L1,7 L9,1 Z");
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-dependencyEnd").attr("class", "marker dependency " + type).attr("refX", 13).attr("refY", 7).attr("markerWidth", 20).attr("markerHeight", 28).attr("orient", "auto").append("path").attr("d", "M 18,7 L9,13 L14,7 L9,1 Z");
}, "dependency");
var lollipop = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((elem, type, id) => {
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-lollipopStart").attr("class", "marker lollipop " + type).attr("refX", 13).attr("refY", 7).attr("markerWidth", 190).attr("markerHeight", 240).attr("orient", "auto").append("circle").attr("stroke", "black").attr("fill", "transparent").attr("cx", 7).attr("cy", 7).attr("r", 6);
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-lollipopEnd").attr("class", "marker lollipop " + type).attr("refX", 1).attr("refY", 7).attr("markerWidth", 190).attr("markerHeight", 240).attr("orient", "auto").append("circle").attr("stroke", "black").attr("fill", "transparent").attr("cx", 7).attr("cy", 7).attr("r", 6);
}, "lollipop");
var point = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((elem, type, id) => {
  elem.append("marker").attr("id", id + "_" + type + "-pointEnd").attr("class", "marker " + type).attr("viewBox", "0 0 10 10").attr("refX", 6).attr("refY", 5).attr("markerUnits", "userSpaceOnUse").attr("markerWidth", 12).attr("markerHeight", 12).attr("orient", "auto").append("path").attr("d", "M 0 0 L 10 5 L 0 10 z").attr("class", "arrowMarkerPath").style("stroke-width", 1).style("stroke-dasharray", "1,0");
  elem.append("marker").attr("id", id + "_" + type + "-pointStart").attr("class", "marker " + type).attr("viewBox", "0 0 10 10").attr("refX", 4.5).attr("refY", 5).attr("markerUnits", "userSpaceOnUse").attr("markerWidth", 12).attr("markerHeight", 12).attr("orient", "auto").append("path").attr("d", "M 0 5 L 10 10 L 10 0 z").attr("class", "arrowMarkerPath").style("stroke-width", 1).style("stroke-dasharray", "1,0");
}, "point");
var circle = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((elem, type, id) => {
  elem.append("marker").attr("id", id + "_" + type + "-circleEnd").attr("class", "marker " + type).attr("viewBox", "0 0 10 10").attr("refX", 11).attr("refY", 5).attr("markerUnits", "userSpaceOnUse").attr("markerWidth", 11).attr("markerHeight", 11).attr("orient", "auto").append("circle").attr("cx", "5").attr("cy", "5").attr("r", "5").attr("class", "arrowMarkerPath").style("stroke-width", 1).style("stroke-dasharray", "1,0");
  elem.append("marker").attr("id", id + "_" + type + "-circleStart").attr("class", "marker " + type).attr("viewBox", "0 0 10 10").attr("refX", -1).attr("refY", 5).attr("markerUnits", "userSpaceOnUse").attr("markerWidth", 11).attr("markerHeight", 11).attr("orient", "auto").append("circle").attr("cx", "5").attr("cy", "5").attr("r", "5").attr("class", "arrowMarkerPath").style("stroke-width", 1).style("stroke-dasharray", "1,0");
}, "circle");
var cross = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((elem, type, id) => {
  elem.append("marker").attr("id", id + "_" + type + "-crossEnd").attr("class", "marker cross " + type).attr("viewBox", "0 0 11 11").attr("refX", 12).attr("refY", 5.2).attr("markerUnits", "userSpaceOnUse").attr("markerWidth", 11).attr("markerHeight", 11).attr("orient", "auto").append("path").attr("d", "M 1,1 l 9,9 M 10,1 l -9,9").attr("class", "arrowMarkerPath").style("stroke-width", 2).style("stroke-dasharray", "1,0");
  elem.append("marker").attr("id", id + "_" + type + "-crossStart").attr("class", "marker cross " + type).attr("viewBox", "0 0 11 11").attr("refX", -1).attr("refY", 5.2).attr("markerUnits", "userSpaceOnUse").attr("markerWidth", 11).attr("markerHeight", 11).attr("orient", "auto").append("path").attr("d", "M 1,1 l 9,9 M 10,1 l -9,9").attr("class", "arrowMarkerPath").style("stroke-width", 2).style("stroke-dasharray", "1,0");
}, "cross");
var barb = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((elem, type, id) => {
...
var addEdgeMarkers = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((svgPath, edge, url, id, diagramType) => {
...
var addEdgeMarker = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((svgPath, position, arrowType, url, id, diagramType) => {
  const endMarkerType = arrowTypesMap[arrowType];
  if (!endMarkerType) {
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.warn(`Unknown arrow type: ${arrowType}`);
    return;
  }
...
var edgeLabels = {};
var terminalLabels = {};
var clear = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(() => {
  edgeLabels = {};
  terminalLabels = {};
}, "clear");
var insertEdgeLabel = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((elem, edge) => {
  const config = (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)();
  const useHtmlLabels = (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ ._3)(config.flowchart.htmlLabels);
  const labelElement = edge.labelType === "markdown" ? (0,_chunk_OERGPBFJ_mjs__WEBPACK_IMPORTED_MODULE_2__/* .createText */ .GZ)(
    elem,
    edge.label,
    {
    ...
    config
  ) : (0,_chunk_Z2VRG6XP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .createLabel_default */ .DA)(edge.label, edge.labelStyle);
  ...
  if (edge.startLabelLeft) {
    const startLabelElement = (0,_chunk_Z2VRG6XP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .createLabel_default */ .DA)(edge.startLabelLeft, edge.labelStyle);
  ...
  if (edge.startLabelRight) {
    const startLabelElement = (0,_chunk_Z2VRG6XP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .createLabel_default */ .DA)(edge.startLabelRight, edge.labelStyle);
  ...
  if (edge.endLabelLeft) {
    const endLabelElement = (0,_chunk_Z2VRG6XP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .createLabel_default */ .DA)(edge.endLabelLeft, edge.labelStyle);
  ...
  if (edge.endLabelRight) {
    const endLabelElement = (0,_chunk_Z2VRG6XP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .createLabel_default */ .DA)(edge.endLabelRight, edge.labelStyle);
...
function setTerminalWidth(fo, value) {
  if ((0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)().flowchart.htmlLabels && fo) {
    fo.style.width = value.length * 9 + "px";
    fo.style.height = "12px";
  }
}
(0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(setTerminalWidth, "setTerminalWidth");
var positionEdgeLabel = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((edge, paths) => {
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug("Moving label abc88 ", edge.id, edge.label, edgeLabels[edge.id], paths);
  let path = paths.updatedPath ? paths.updatedPath : paths.originalPath;
  const siteConfig = (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)();
  const { subGraphTitleTotalMargin } = (0,_chunk_TINLTEC2_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getSubGraphTitleMargins */ .O)(siteConfig);
  if (edge.label) {
    const el = edgeLabels[edge.id];
    let x = edge.x;
    let y = edge.y;
    if (path) {
      const pos = _chunk_VKXSJROQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.calcLabelPosition(path);
      _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug(
  ...
  if (edge.startLabelLeft) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _chunk_VKXSJROQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.calcTerminalLabelPosition(edge.arrowTypeStart ? 10 : 0, "start_left", path);
      x = pos.x;
      y = pos.y;
    }
  ...
  if (edge.startLabelRight) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _chunk_VKXSJROQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.calcTerminalLabelPosition(
  ...
  if (edge.endLabelLeft) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _chunk_VKXSJROQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.calcTerminalLabelPosition(edge.arrowTypeEnd ? 10 : 0, "end_left", path);
      x = pos.x;
      y = pos.y;
    }
    el.attr("transform", `translate(${x}, ${y})`);
  ...
  if (edge.endLabelRight) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _chunk_VKXSJROQ_mjs__WEBPACK_IMPORTED_MODULE_3__/* .utils_default */ ._K.calcTerminalLabelPosition(edge.arrowTypeEnd ? 10 : 0, "end_right", path);
      x = pos.x;
      y = pos.y;
    }
    el.attr("transform", `translate(${x}, ${y})`);
...
var outsideNode = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((node, point2) => {
  const x = node.x;
  const y = node.y;
...
var intersection = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((node, outsidePoint, insidePoint) => {
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug(`intersection calc abc89:
  ...
  if (Math.abs(y - outsidePoint.y) * w > Math.abs(x - outsidePoint.x) * h) {
    ...
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug(`abc89 topp/bott calc, Q ${Q}, q ${q}, R ${R}, r ${r}`, res);
    return res;
  } else {
    ...
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug(`sides calc abc89, Q ${Q}, q ${q}, R ${R}, r ${r}`, { _x, _y });
    if (r === 0) {
      _x = outsidePoint.x;
      _y = outsidePoint.y;
    }
...
var cutPathAtIntersect = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((_points, boundaryNode) => {
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug("abc88 cutPathAtIntersect", _points, boundaryNode);
  let points = [];
...
var insertEdge = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(function(elem, e, edge, clusterDb, diagramType, graph, id) {
  let points = edge.points;
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug("abc88 InsertEdge: edge=", edge, "e=", e);
  ...
  if (edge.toCluster) {
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug("to cluster abc88", clusterDb[edge.toCluster]);
    points = cutPathAtIntersect(edge.points, clusterDb[edge.toCluster].node);
    pointsHasChanged = true;
  }
  if (edge.fromCluster) {
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .Rm.debug("from cluster abc88", clusterDb[edge.fromCluster]);
  ...
  const { x, y } = (0,_chunk_TINLTEC2_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getLineFunctionsWithOffset */ .R)(edge);
  ...
  let url = "";
  if ((0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)().flowchart.arrowMarkerAbsolute || (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .D7)().state.arrowMarkerAbsolute) {
...
/* harmony export */ });
/* harmony import */ var _chunk_PDCO53Z4_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(31953);
/* harmony import */ var _chunk_IBIA4ERB_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(82207);
/* harmony import */ var _chunk_Z2VRG6XP_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(46578);
/* harmony import */ var _chunk_TINLTEC2_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(48496);
/* harmony import */ var _chunk_OERGPBFJ_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(67895);
/* harmony import */ var _chunk_VKXSJROQ_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(57323);
/* harmony import */ var _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(64994);
...
var descendants = {};
var parents = {};
var clear3 = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(() => {
  descendants = {};
  parents = {};
  clusterDb = {};
}, "clear");
var isDescendant = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((id, ancestorId) => {
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.trace("In isDescendant", ancestorId, " ", id, " = ", descendants[ancestorId].includes(id));
  if (descendants[ancestorId].includes(id)) {
    return true;
  }
  return false;
}, "isDescendant");
var edgeInCluster = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((edge, clusterId) => {
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("Descendants of ", clusterId, " is ", descendants[clusterId]);
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("Edge is ", edge);
  if (edge.v === clusterId) {
    return false;
  }
  if (edge.w === clusterId) {
  ...
  if (!descendants[clusterId]) {
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.debug("Tilt, ", clusterId, ",not in descendants");
    return false;
  }
  return descendants[clusterId].includes(edge.v) || isDescendant(edge.v, clusterId) || isDescendant(edge.w, clusterId) || descendants[clusterId].includes(edge.w);
}, "edgeInCluster");
var copy = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((clusterId, graph, newGraph, rootId) => {
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn(
    "Copying children of ",
    clusterId,
    "root",
    rootId,
  ...
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn("Copying (nodes) clusterId", clusterId, "nodes", nodes);
  nodes.forEach((node) => {
    if (graph.children(node).length > 0) {
      copy(node, graph, newGraph, rootId);
    } else {
      const data = graph.node(node);
      _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("cp ", node, " to ", rootId, " with parent ", clusterId);
      newGraph.setNode(node, data);
      if (rootId !== graph.parent(node)) {
        _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn("Setting parent", node, graph.parent(node));
        newGraph.setParent(node, graph.parent(node));
      }
      if (clusterId !== rootId && node !== clusterId) {
        _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.debug("Setting parent", node, clusterId);
        newGraph.setParent(node, clusterId);
      } else {
        _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("In copy ", clusterId, "root", rootId, "data", graph.node(clusterId), rootId);
        _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.debug(
      ...
      _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.debug("Copying Edges", edges);
      edges.forEach((edge) => {
        _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("Edge", edge);
        const data2 = graph.edge(edge.v, edge.w, edge.name);
        _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("Edge data", data2, rootId);
        try {
          if (edgeInCluster(edge, rootId)) {
            _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("Copying as ", edge.v, edge.w, data2, edge.name);
            newGraph.setEdge(edge.v, edge.w, data2, edge.name);
            _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("newGraph edges ", newGraph.edges(), newGraph.edge(newGraph.edges()[0]));
          } else {
            _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info(
          ...
          _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.error(e);
        }
      });
    }
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.debug("Removing node", node);
    graph.removeNode(node);
  });
}, "copy");
var extractDescendants = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((id, graph) => {
...
var findNonClusterChild = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((id, graph) => {
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.trace("Searching", id);
  const children = graph.children(id);
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.trace("Searching children of id ", id, children);
  if (children.length < 1) {
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.trace("This is a valid node", id);
    return id;
  }
  for (const child of children) {
    const _id = findNonClusterChild(child, graph);
    if (_id) {
      _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.trace("Found replacement for", id, " => ", _id);
      return _id;
    }
  }
}, "findNonClusterChild");
var getAnchorId = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((id) => {
  if (!clusterDb[id]) {
    return id;
  }
...
var adjustClustersAndEdges = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((graph, depth) => {
  if (!graph || depth > 10) {
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.debug("Opting out, no graph ");
    return;
  } else {
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.debug("Opting in, graph ");
  }
  ...
  graph.nodes().forEach(function(id) {
    ...
    if (children.length > 0) {
      _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.debug("Cluster identified", id, descendants);
      edges.forEach((edge) => {
        if (edge.v !== id && edge.w !== id) {
          const d1 = isDescendant(edge.v, id);
          const d2 = isDescendant(edge.w, id);
          if (d1 ^ d2) {
            _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn("Edge: ", edge, " leaves cluster ", id);
            _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn("Descendants of XXX ", id, ": ", descendants[id]);
            clusterDb[id].externalConnections = true;
          }
        }
      });
    } else {
      _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.debug("Not a cluster ", id, descendants);
    }
  });
  ...
  graph.edges().forEach(function(e) {
    ...
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(e));
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(graph.edge(e)));
    let v = e.v;
    let w = e.w;
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn(
      "Fix XXX",
    ...
    if (clusterDb[e.v] && clusterDb[e.w] && clusterDb[e.v] === clusterDb[e.w]) {
      _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn("Fixing and trixing link to self - removing XXX", e.v, e.w, e.name);
      _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn("Fixing and trixing - removing XXX", e.v, e.w, e.name);
      v = getAnchorId(e.v);
      w = getAnchorId(e.w);
      ...
      _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn("Fix Replacing with XXX", v, w, e.name);
      graph.setEdge(v, w, edge, e.name);
    }
  });
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn("Adjusted Graph", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_10__/* .write */ .M(graph));
  extractor(graph, 0);
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.trace(clusterDb);
}, "adjustClustersAndEdges");
var extractor = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((graph, depth) => {
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn("extractor - ", depth, dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_10__/* .write */ .M(graph), graph.children("D"));
  if (depth > 10) {
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.error("Bailing out");
    return;
  }
  ...
  if (!hasChildren) {
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.debug("Done, no node has children", graph.nodes());
    return;
  }
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.debug("Nodes = ", nodes, depth);
  for (const node of nodes) {
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.debug(
      "Extracting node",
      node,
    ...
    if (!clusterDb[node]) {
      _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.debug("Not a cluster", node, depth);
    ...
    graph.children(node) && graph.children(node).length > 0) {
      ...
      if (clusterDb[node]?.clusterData?.dir) {
        ...
        _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn("Fixing dir", clusterDb[node].clusterData.dir, dir);
      }
      ...
      _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn("Old graph before copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_10__/* .write */ .M(graph));
      ...
      _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn("New graph after copy node: (", node, ")", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_10__/* .write */ .M(clusterGraph));
      _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.debug("Old graph after copy", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_10__/* .write */ .M(graph));
    } else {
      _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn(
        "Cluster ** ",
        node,
      ...
      _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.debug(clusterDb);
    }
  }
  nodes = graph.nodes();
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn("New list of nodes", nodes);
  for (const node of nodes) {
    const data = graph.node(node);
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn(" Now next level", node, data);
    if (data.clusterNode) {
      extractor(data.graph, depth + 1);
    }
  }
}, "extractor");
var sorter = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((graph, nodes) => {
  if (nodes.length === 0) {
    return [];
  }
...
var sortNodesByHierarchy = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((graph) => sorter(graph, graph.children()), "sortNodesByHierarchy");

// src/dagre-wrapper/clusters.js

var rect = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((parent, node) => {
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("Creating subgraph rect for ", node.id, node);
  const siteConfig = (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)();
  const shapeSvg = parent.insert("g").attr("class", "cluster" + (node.class ? " " + node.class : "")).attr("id", node.id);
  const rect2 = shapeSvg.insert("rect", ":first-child");
  const useHtmlLabels = (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .evaluate */ ._3)(siteConfig.flowchart.htmlLabels);
  const label = shapeSvg.insert("g").attr("class", "cluster-label");
  const text = node.labelType === "markdown" ? (0,_chunk_OERGPBFJ_mjs__WEBPACK_IMPORTED_MODULE_4__/* .createText */ .GZ)(label, node.labelText, { style: node.labelStyle, useHtmlLabels }, siteConfig) : label.node().appendChild((0,_chunk_Z2VRG6XP_mjs__WEBPACK_IMPORTED_MODULE_2__/* .createLabel_default */ .DA)(node.labelText, node.labelStyle, void 0, true));
  let bbox = text.getBBox();
  if ((0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .evaluate */ ._3)(siteConfig.flowchart.htmlLabels)) {
    const div = text.children[0];
  ...
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.trace("Data ", node, JSON.stringify(node));
  rect2.attr("style", node.style).attr("rx", node.rx).attr("ry", node.ry).attr("x", node.x - width / 2).attr("y", node.y - node.height / 2 - halfPadding).attr("width", width).attr("height", node.height + padding);
  const { subGraphTitleTopMargin } = (0,_chunk_TINLTEC2_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getSubGraphTitleMargins */ .O)(siteConfig);
  if (useHtmlLabels) {
    label.attr(
      "transform",
  ...
  node.intersect = function(point) {
    return (0,_chunk_Z2VRG6XP_mjs__WEBPACK_IMPORTED_MODULE_2__/* .intersect_rect_default */ .nM)(node, point);
  };
  return shapeSvg;
}, "rect");
var noteGroup = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((parent, node) => {
...
var roundedWithTitle = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((parent, node) => {
  const siteConfig = (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)();
  const shapeSvg = parent.insert("g").attr("class", node.classes).attr("id", node.id);
  const rect2 = shapeSvg.insert("rect", ":first-child");
  const label = shapeSvg.insert("g").attr("class", "cluster-label");
  const innerRect = shapeSvg.append("rect");
  const text = label.node().appendChild((0,_chunk_Z2VRG6XP_mjs__WEBPACK_IMPORTED_MODULE_2__/* .createLabel_default */ .DA)(node.labelText, node.labelStyle, void 0, true));
  let bbox = text.getBBox();
  if ((0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .evaluate */ ._3)(siteConfig.flowchart.htmlLabels)) {
    const div = text.children[0];
    const dv = (0,d3__WEBPACK_IMPORTED_MODULE_7__/* .select */ .Ltv)(text);
  ...
  label.attr(
    "transform",
    `translate(${node.x - bbox.width / 2}, ${node.y - node.height / 2 - node.padding / 3 + ((0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .evaluate */ ._3)(siteConfig.flowchart.htmlLabels) ? 5 : 3) + subGraphTitleTopMargin})`
  );
  const rectBox = rect2.node().getBBox();
  node.height = rectBox.height;
  node.intersect = function(point) {
...
var divider = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((parent, node) => {
  const shapeSvg = parent.insert("g").attr("class", node.classes).attr("id", node.id);
  const rect2 = shapeSvg.insert("rect", ":first-child");
  const padding = 0 * node.padding;
  const halfPadding = padding / 2;
...
var clusterElems = {};
var insertCluster = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((elem, node) => {
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.trace("Inserting cluster");
  const shape = node.shape || "rect";
  clusterElems[node.id] = shapes[shape](elem, node);
}, "insertCluster");
var clear4 = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(() => {
  clusterElems = {};
}, "clear");

// src/dagre-wrapper/index.js
var recursiveRender = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(async (_elem, graph, diagramType, id, parentCluster, siteConfig) => {
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("Graph in recursive render: XXX", dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_10__/* .write */ .M(graph), parentCluster);
  const dir = graph.graph().rankdir;
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.trace("Dir in recursive render - dir:", dir);
  const elem = _elem.insert("g").attr("class", "root");
  if (!graph.nodes()) {
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("No nodes found for", graph);
  } else {
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("Recursive render XXX", graph.nodes());
  }
  if (graph.edges().length > 0) {
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.trace("Recursive edges", graph.edge(graph.edges()[0]));
  }
  ...
  await Promise.all(
    graph.nodes().map(async function(v) {
      ...
      if (parentCluster !== void 0) {
        ...
        _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("Setting data for cluster XXX (", v, ") ", data, parentCluster);
        graph.setNode(parentCluster.id, data);
        if (!graph.parent(v)) {
          _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.trace("Setting parent", v, parentCluster.id);
          graph.setParent(v, parentCluster.id, data);
        }
      }
      _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("(Insert) Node XXX" + v + ": " + JSON.stringify(graph.node(v)));
      if (node?.clusterNode) {
        _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("Cluster identified", v, node.width, graph.node(v));
        ...
        const newEl = o.elem;
        (0,_chunk_Z2VRG6XP_mjs__WEBPACK_IMPORTED_MODULE_2__/* .updateNodeBounds */ .lC)(node, newEl);
        node.diff = o.diff || 0;
        _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("Node bounds (abc123)", v, node, node.width, node.x, node.y);
        (0,_chunk_Z2VRG6XP_mjs__WEBPACK_IMPORTED_MODULE_2__/* .setNodeElem */ .U7)(newEl, node);
        _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn("Recursive render complete ", newEl, node);
      } else {
        if (graph.children(v).length > 0) {
          _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("Cluster - the non recursive path XXX", v, node.id, node, graph);
          _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info(findNonClusterChild(node.id, graph));
          clusterDb[node.id] = { id: findNonClusterChild(node.id, graph), node };
        } else {
          _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("Node - the non recursive path", v, node.id, node);
          await (0,_chunk_Z2VRG6XP_mjs__WEBPACK_IMPORTED_MODULE_2__/* .insertNode */ .on)(nodes, graph.node(v), dir);
        }
      }
    })
  );
  graph.edges().forEach(async function(e) {
    ...
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(e));
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("Edge " + e.v + " -> " + e.w + ": ", e, " ", JSON.stringify(graph.edge(e)));
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("Fix", clusterDb, "ids:", e.v, e.w, "Translating: ", clusterDb[e.v], clusterDb[e.w]);
    await (0,_chunk_PDCO53Z4_mjs__WEBPACK_IMPORTED_MODULE_0__/* .insertEdgeLabel */ .jP)(edgeLabels, edge);
  });
  graph.edges().forEach(function(e) {
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(e));
  });
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("Graph before layout:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_10__/* .write */ .M(graph)));
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("#############################################");
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("###                Layout                 ###");
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("#############################################");
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info(graph);
  (0,dagre_d3_es_src_dagre_index_js__WEBPACK_IMPORTED_MODULE_9__/* .layout */ .Zp)(graph);
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("Graph after layout:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_10__/* .write */ .M(graph)));
  let diff = 0;
  const { subGraphTitleTotalMargin } = (0,_chunk_TINLTEC2_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getSubGraphTitleMargins */ .O)(siteConfig);
  sortNodesByHierarchy(graph).forEach(function(v) {
    const node = graph.node(v);
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("Position " + v + ": " + JSON.stringify(graph.node(v)));
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info(
      "Position " + v + ": (" + node.x,
      "," + node.y,
      ") width: ",
    ...
    if (node?.clusterNode) {
      ...
      (0,_chunk_Z2VRG6XP_mjs__WEBPACK_IMPORTED_MODULE_2__/* .positionNode */ .U_)(node);
    } else {
      if (graph.children(v).length > 0) {
  ...
  graph.edges().forEach(function(e) {
    const edge = graph.edge(e);
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(edge), edge);
    edge.points.forEach((point) => point.y += subGraphTitleTotalMargin / 2);
    const paths = (0,_chunk_PDCO53Z4_mjs__WEBPACK_IMPORTED_MODULE_0__/* .insertEdge */ .Jo)(edgePaths, e, edge, clusterDb, diagramType, graph, id);
    (0,_chunk_PDCO53Z4_mjs__WEBPACK_IMPORTED_MODULE_0__/* .positionEdgeLabel */ .T_)(edge, paths);
  });
  graph.nodes().forEach(function(v) {
    const n = graph.node(v);
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info(v, n.type, n.diff);
    if (n.type === "group") {
      diff = n.diff;
    }
  });
...
var render = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(async (elem, graph, markers, diagramType, id) => {
  (0,_chunk_PDCO53Z4_mjs__WEBPACK_IMPORTED_MODULE_0__/* .markers_default */ .g0)(elem, markers, diagramType, id);
  (0,_chunk_Z2VRG6XP_mjs__WEBPACK_IMPORTED_MODULE_2__/* .clear */ .IU)();
  (0,_chunk_PDCO53Z4_mjs__WEBPACK_IMPORTED_MODULE_0__/* .clear */ .IU)();
  clear4();
  clear3();
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn("Graph at first:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_10__/* .write */ .M(graph)));
  adjustClustersAndEdges(graph);
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.warn("Graph after:", JSON.stringify(dagre_d3_es_src_graphlib_json_js__WEBPACK_IMPORTED_MODULE_10__/* .write */ .M(graph)));
  const siteConfig = (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)();
  await recursiveRender(elem, graph, diagramType, id, void 0, siteConfig);
}, "render");

// src/diagrams/class/classRenderer-v2.ts
var sanitizeText = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((txt) => _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .common_default */ .Y2.sanitizeText(txt, (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)()), "sanitizeText");
var conf = {
  dividerMargin: 10,
  padding: 5,
  textHeight: 10,
...
var addNamespaces = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(function(namespaces, g, _id, diagObj) {
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("keys:", [...namespaces.keys()]);
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info(namespaces);
  namespaces.forEach(function(vertex) {
    ...
    const node = {
      ...
      padding: (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)().flowchart?.padding ?? (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)().class?.padding
    };
    g.setNode(vertex.id, node);
    addClasses(vertex.classes, g, _id, diagObj, vertex.id);
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("setNode", node);
  });
}, "addNamespaces");
var addClasses = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(function(classes, g, _id, diagObj, parent) {
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("keys:", [...classes.keys()]);
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info(classes);
  [...classes.values()].filter((vertex) => vertex.parent === parent).forEach(function(vertex) {
    const cssClassStr = vertex.cssClasses.join(" ");
    const styles = (0,_chunk_VKXSJROQ_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getStylesFromArray */ .sM)(vertex.styles);
...
var addNotes = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(function(notes, g, startEdgeId, classes) {
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info(notes);
  notes.forEach(function(note, i) {
    ...
    const edgeData = {
      ...
      style: "fill:none",
      labelStyle: "",
      curve: (0,_chunk_VKXSJROQ_mjs__WEBPACK_IMPORTED_MODULE_5__/* .interpolateToCurve */ .Ib)(conf.curve, d3__WEBPACK_IMPORTED_MODULE_7__/* .curveLinear */ .lUB)
    };
    g.setEdge(vertex.id, vertex.class, edgeData, edgeId);
  });
}, "addNotes");
var addRelations = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(function(relations, g) {
  const conf2 = (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)().flowchart;
  let cnt = 0;
  relations.forEach(function(edge) {
    ...
    const edgeData = {
      ...
      id: (0,_chunk_VKXSJROQ_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getEdgeId */ .rY)(edge.id1, edge.id2, {
        prefix: "id",
        counter: cnt
      }),
      // Set link type for rendering
      ...
      style: "fill:none",
      labelStyle: "",
      curve: (0,_chunk_VKXSJROQ_mjs__WEBPACK_IMPORTED_MODULE_5__/* .interpolateToCurve */ .Ib)(conf2?.curve, d3__WEBPACK_IMPORTED_MODULE_7__/* .curveLinear */ .lUB)
    };
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info(edgeData, edge);
    if (edge.style !== void 0) {
      const styles = (0,_chunk_VKXSJROQ_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getStylesFromArray */ .sM)(edge.style);
    ...
    if (edge.text === void 0) {
      ...
      edgeData.arrowheadStyle = "fill: #333";
      edgeData.labelpos = "c";
      if ((0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)().flowchart?.htmlLabels ?? (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)().htmlLabels) {
        edgeData.labelType = "html";
        edgeData.label = '<span class="edgeLabel">' + edge.text + "</span>";
      } else {
        edgeData.labelType = "text";
        edgeData.label = edge.text.replace(_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .common_default */ .Y2.lineBreakRegex, "\n");
        if (edge.style === void 0) {
...
var setConf = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(function(cnf) {
  conf = {
    ...conf,
    ...cnf
  };
}, "setConf");
var draw = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(async function(text, id, _version, diagObj) {
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("Drawing class - ", id);
  const conf2 = (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)().flowchart ?? (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)().class;
  const securityLevel = (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .getConfig2 */ .D7)().securityLevel;
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info("config:", conf2);
  ...
  _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .log */ .Rm.info(relations);
  ...
  _chunk_VKXSJROQ_mjs__WEBPACK_IMPORTED_MODULE_5__/* .utils_default */ ._K.insertTitle(svg, "classTitleText", conf2?.titleTopMargin ?? 5, diagObj.db.getDiagramTitle());
  (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .setupGraphViewbox */ .ot)(g, svg, conf2?.diagramPadding, conf2?.useMaxWidth);
  if (!conf2?.htmlLabels) {
...
(0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)(getArrowMarker, "getArrowMarker");
...
var diagram = {
  parser: _chunk_IBIA4ERB_mjs__WEBPACK_IMPORTED_MODULE_1__/* .classDiagram_default */ ._$,
  db: _chunk_IBIA4ERB_mjs__WEBPACK_IMPORTED_MODULE_1__/* .classDb_default */ .z2,
  renderer: classRenderer_v2_default,
  styles: _chunk_IBIA4ERB_mjs__WEBPACK_IMPORTED_MODULE_1__/* .styles_default */ .tM,
  init: /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_6__/* .__name */ .K2)((cnf) => {
    if (!cnf.class) {
      cnf.class = {};
    }
    cnf.class.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    _chunk_IBIA4ERB_mjs__WEBPACK_IMPORTED_MODULE_1__/* .classDb_default */ .z2.clear();
  }, "init")
};
