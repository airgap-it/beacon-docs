...
var DEFAULT_PACKET_CONFIG = _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_3__/* .defaultConfig_default */ .UI.packet;
var getConfig2 = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => {
  const config = (0,_chunk_VKXSJROQ_mjs__WEBPACK_IMPORTED_MODULE_1__/* .cleanAndMerge */ .$t)({
    ...DEFAULT_PACKET_CONFIG,
    ...(0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig */ .zj)().packet
  });
  if (config.showBits) {
    config.paddingY += 10;
  }
...
var getPacket = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(() => data.packet, "getPacket");
var pushWord = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((word) => {
  if (word.length > 0) {
...
var populate = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((ast) => {
  (0,_chunk_JJENOPKO_mjs__WEBPACK_IMPORTED_MODULE_0__/* .populateCommonDb */ .S)(ast, db);
  let lastByte = -1;
  let word = [];
  let row = 1;
  ...
  for (let { start, end, label } of ast.blocks) {
    ...
    lastByte = end ?? start;
    _chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .Rm.debug(`Packet block ${start} - ${lastByte} with label ${label}`);
...
var getNextFittingBlock = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((block, row, bitsPerRow) => {
  if (block.end === void 0) {
...
var draw = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((_text, id, _version, diagram2) => {
  ...
  (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_3__/* .configureSvgSize */ .a$)(svg, svgHeight, svgWidth, config.useMaxWidth);
  for (const [word, packet] of words.entries()) {
    drawWord(svg, packet, word, config);
  }
  svg.append("text").text(title).attr("x", svgWidth / 2).attr("y", svgHeight - totalRowHeight / 2).attr("dominant-baseline", "middle").attr("text-anchor", "middle").attr("class", "packetTitle");
}, "draw");
var drawWord = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)((svg, word, rowNumber, { rowHeight, paddingX, paddingY, bitWidth, bitsPerRow, showBits }) => {
...
var styles = /* @__PURE__ */ (0,_chunk_O2AGWWWV_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .K2)(({ packet } = {}) => {
  const options = (0,_chunk_VKXSJROQ_mjs__WEBPACK_IMPORTED_MODULE_1__/* .cleanAndMerge */ .$t)(defaultPacketStyleOptions, packet);
  return `
	.packetByte {
