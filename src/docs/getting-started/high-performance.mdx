...
See an example contract call without taquito [here](/guides/simple-contract-call)
...
const contractInfo = {}; // A JSON file of the contract storage.
...
<!-- embedme example-high-performance-set-fees.ts -->
