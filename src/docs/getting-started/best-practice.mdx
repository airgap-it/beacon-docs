...
When only supporting a certain wallet, the label could directly indetify the wallet e.g. "Connect AirGap Wallet"
...
Button label has the wording "Connect Button"

#### Connected

- The button has a connection indicator e.g. a green desktop
...
- A click on the button prompts a dropdown:
  - Disconnect Wallet - Disconnects the wallet from the dApp, resetting the button state and prompting a new Beacon Connection request when the user clicks again
