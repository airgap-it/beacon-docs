...
The example below creates a new `BeaconWalletClient` instance with default settings. See the [Configuration](/wallet/advanced/android/configuration) guide to learn about a more advanced setup.
