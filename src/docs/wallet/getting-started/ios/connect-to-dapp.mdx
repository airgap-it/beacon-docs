...
The example below creates a new `Beacon.WalletClient` instance with default settings. See the [Configuration](/wallet/advanced/ios/configuration) guide to learn about a more advanced setup.
