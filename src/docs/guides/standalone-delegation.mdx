...
<html lang="en">
  <head>
    ...
    -->
    <script 
      src="https://unpkg.com/@airgap/beacon-sdk@2.3.10/dist/walletbeacon.min.js"
      integrity="sha384-jjvS2HoCSABXKPc0w5cr+4Xt9sfRp545l0s9R8o7y7+vH2DSFb5GV0rptLfZPuvu"
