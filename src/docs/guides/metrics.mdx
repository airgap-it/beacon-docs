...
:::warning
Participation in this program requires dApp developers to share the [origin](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Origin) of their dApp with our team.
:::
...
:::note
userId is a UUID generated during the first initialization, not on page refresh.
:::
