...
In this guide, you'll learn how to integrate the [Beacon SDK](https://docs.airgap.it/beacon-sdk) into your Next.js project.
...
Open your browser and navigate to the page you modified (e.g., [http://localhost:3000](http://localhost:3000)).
You should see a "Hello World" message with a button labeled "Request Permissions." Clicking the button will invoke Beacon SDK's permission request.
