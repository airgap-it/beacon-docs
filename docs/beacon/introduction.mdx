...
Generally, you only have to initialize a DAppClient instance (see [Getting Started](/getting-started/example)), the rest should be handled for you.
Refer to the [examples](/guides/getting-started) section for some common use cases.
