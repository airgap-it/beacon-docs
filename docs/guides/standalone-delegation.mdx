...
<html lang="en">
  <head>
    ...
    <!--
      Make sure you replace "2.0.0" with the latest version.
      https://www.srihash.org/
    -->
    <script
      src="https://unpkg.com/@airgap/beacon-sdk@2.0.0/dist/walletbeacon.min.js"
      integrity="sha384-iXEbmcoWK3vSKOMS6jKOH7AXR8CfeaDUUZhVp5PJgugW97bxWtoArN7+s35weqAH"
